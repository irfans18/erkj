   ...
   <header class="max-h-6 pb-12" style="font-family: 'Poppins', sans-serif">
			<div class="container mx-auto flex flex-wrap flex-row items-center justify-between">
				<nav
					...
					<a href="index.html"
						class="text-orange-rkj hover:text-white hover:bg-orange-rkj rounded-lg p-0 lg:p-2 nav-link">Beranda</a>
					<a href="index.html#catalog"
						class="text-orange-rkj hover:text-white hover:bg-orange-rkj rounded-lg p-0 lg:p-2 nav-link">Produk</a>
					<a target="_blank"
						...
						class="text-orange-rkj hover:text-white hover:bg-orange-rkj rounded-lg p-0 lg:p-2 nav-link">Workshop</a>
					<a href="about.html"
						class="text-orange-rkj hover:text-white hover:bg-orange-rkj rounded-lg p-0 lg:p-2 nav-link">About
						Us</a>
				</nav>
				<a href="index.html"
				...
				<div class="hidden w-full flex-wrap items-center text-base justify-center" id="menu">
					<nav
						...
						<a href="index.html" class="nav-link block active">Beranda</a>
						<a href="index.html#catalog" class="nav-link block">Produk</a>
						<a href="https://api.whatsapp.com/send?phone=6289670155097&text=Hallo kak. Saya [nama] tertarik dengan kejugja, Boleh minta info lebih lanjut terkait produk/workshop?"
							class="nav-link block">Workshop</a>
						<a href="about.html" class="nav-link block">About Us</a>
					</nav>
				</div>
				<div class="lg:w-2/5 lg:inline-flex text-center py-4 lg:justify-end ml-0 hidden lg:items-center w-full"
					id="menu">
					<a href="mailto:rumahkejujogja@gmail.com"
